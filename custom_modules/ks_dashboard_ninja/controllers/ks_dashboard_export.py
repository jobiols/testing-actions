...
class KsDashboardExport(ExportFormat, http.Controller):
    ...
    def base(self, data, token):
        ...
        header, dashboard_data = operator.itemgetter('header',
                                                     'dashboard_data')(params)
...
class KsDashboardJsonExport(KsDashboardExport, http.Controller):
    ...
    @http.route('/ks_dashboard_ninja/export/dashboard_json',
                type='http',
                auth="user")
    @serialize_exception
...
class KsItemJsonExport(KsDashboardExport, http.Controller):
    ...
    @http.route('/ks_dashboard_ninja/export/item_json',
                type='http',
                auth="user")
    @serialize_exception
    def index(self, data, token):
        ...
        data['dashboard_data'] = request.env[
            'ks_dashboard_ninja.board'].ks_export_item(item_id)
