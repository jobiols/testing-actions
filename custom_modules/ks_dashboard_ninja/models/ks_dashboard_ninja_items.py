...
from odoo.addons.ks_dashboard_ninja.lib.ks_date_filter_selections import (
    ks_get_date,
    ks_convert_into_utc,
...
class KsDashboardNinjaItems(models.Model):
    ...
    ks_chart_cumulative_field = fields.Many2one(
        "ir.model.fields", string="Cumulative Field", help="Data points to be selected."
    )
    ...
    @api.depends(
        "ks_multiplier_active", "ks_chart_measure_field", "ks_list_view_group_fields"
    )
            ...
            if rec.ks_chart_data_count_type == "count":
                ...
                for res in rec.ks_chart_measure_field:
                    ...
                    if (
                        ...
                        and rec.ks_chart_cumulative_field.name == res.name
                    ):
                        ks_chart_data["datasets"].append(
                            {
                                "data": [],
