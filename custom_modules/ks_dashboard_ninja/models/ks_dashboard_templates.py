...
class KsDashboardNinjaTemplate(models.Model):
    ...
    ks_template_type = fields.Selection([('ks_default', 'Predefined'),
                                         ('ks_custom', 'Custom')],
                                        string="Template Format")
    ks_dashboard_item_ids = fields.One2many('ks_dashboard_ninja.item',
        ...
        for val in vals_list:
            if val.get('ks_template_type', False) and val.get(
                ...
                val['ks_dashboard_item_ids'] = [
                    ...
                    }).id) for x in dashboard_id.ks_dashboard_items_ids
                ]
